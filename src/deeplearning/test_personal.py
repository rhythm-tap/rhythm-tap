...
#---------------------------------------------------------------------------------------------------
# ハイパーパラメータ
data_dir = "../data_auth_dl"  # テストデータのディレクトリを指定
batch_size = 64
base_dir = "/Users/user/"
...
def test_personal(_personal_name, _log_name):
    ...
    #---------------------------------------------------------------------------------------------------
    # テストデータの準備
    test_data, _, _, _ = makePersonalCsvPathList(_personal_name, dir_path=data_dir, validation_rate=0, test_rate=0, shuffle=True)
